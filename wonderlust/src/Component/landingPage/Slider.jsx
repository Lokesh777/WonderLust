  ...
  return (
    <div className={classes.root} style={{ backgroundColor: "#f8e9ff" }}>
      <AppBar position="static" color="default" className={classes.header}>
        ...
        >
          <Tab
            style={{ textTransform: "none", width: `${100 / 6}%` }}
            onMouseOver={(e) => {
            ...
            label="Stays"
            icon={<ApartmentIcon style={{ color: "#505c66", width: "25px" }} />}
            {...a11yProps(0)}
          />
          <Tab
            style={{ textTransform: "none", width: `${100 / 6}%` }}
            ...
            label="Flights"
            icon={<FlightIcon style={{ color: "#505c66", width: "25px" }} />}
            {...a11yProps(1)}
          />
          <Tab
            style={{ textTransform: "none", width: `${100 / 6}%` }}
            ...
            label="Cars"
            icon={<DriveEtaIcon style={{ color: "#505c66", width: "25px" }} />}
            {...a11yProps(2)}
          />
          <Tab
            style={{ textTransform: "none", width: `${100 / 6}%` }}
            ...
            icon={
              <svg width="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <svg>
                  <path
                    fill="#505c66"
                    d="M22 10.18V6H2v4.18c.9 0 1.66.75 1.66 1.66 0 .9-.76 1.66-1.66 1.66v4.18h20V13.5c-.9 0-1.66-.76-1.66-1.66 0-.9.76-1.66 1.66-1.66zm-4.16 4.57c0 .23-.2.43-.43.43H6.59a.43.43 0 01-.43-.43V8.93c0-.23.2-.43.43-.43h10.82c.23 0 .43.2.43.43v5.82zm-10-4.57h8.32v3.32H7.84v-3.32z"
                  ></path>
                </svg>
              </svg>
            }
              ...
              <svg width="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <svg>
                  <path
                    path
                    fill="#505c66"
                    d="M20.34 10.96v1.68c0 .13-.06.24-.14.32-2.21 1.99-3.51 4.72-4.58 7.45-.24.62-.4 1.05-.48 1.3a.4.4 0 01-.39.29h-5.5a.4.4 0 01-.4-.3c-.07-.24-.23-.67-.47-1.3-1.06-2.7-2.4-5.47-4.58-7.44a.44.44 0 01-.14-.32v-1.68c0-.18.11-.33.3-.4l6.5-2.17c.23-.05.54.08.54.35L12 16l1-7.26c0-.28.3-.4.54-.35l6.5 2.16c.19.08.3.23.3.41zM5.83 8.2L12 6.12l6.17 2.07-1.72-3.14h1.66l-.47-1.37a.4.4 0 00-.39-.3h-4.14v-.97c0-.23-.2-.41-.4-.41H11.3c-.21 0-.41.18-.41.41v.98H6.75a.4.4 0 00-.4.29L5.9 5.05h1.66L5.83 8.19z"
                  ></path>
                </svg>
              </svg>
            }
      ...
      <TabPanel value={value} index={0}>
          ...
          >
            ...
            <div className={styles.HeadingGoingto}>
              {goingToVal === "" ? (
                ...
                <div>
                  <div className={styles.checkInHeading}>Going to</div>
                  <div className={styles.checkinDate}>{goingToVal}</div>
                </div>
              )}
            </div>
            ...
            <div className={styles.searchBox} style={{ display: `${openLocationSearch}` }}>
              ...
              <div className={styles.searchResultHight}>
                ...
                {searchQueryResult.map((data) => {
                  return (
                    <div key={uuid()} className={styles.SearchResult}>
                      <div
                        className={styles.SearchResultIndividual}
                        onClick={(e) => {
                          handleCloseLocation(`${data.name}`, e);
                        }}
                      >
                        ...
                        <div
                          ...
                          className={styles.SearchResultsMapping}
                        >
                          <strong id="strong_data_name" style={{ textTransform: "capitalize" }}>
                            {data.name}
                          </strong>
          ...
          >
            ...
            <div className={styles.HeadingGoingto}>
              ...
              <div className={styles.checkinDate}>
                {trevelersRoomCnt} room, {AdultsTrevelers} travelers
              </div>
            </div>
            ...
            <div className={styles.traverlersPopup} style={{ display: `${trevelersPopupOpen}` }}>
              ...
              <div className={styles.trevelersFlexContainer}>
                ...
                <div className={styles.trevelersFlexChild}>
                  <div
                    className={styles.increseDecreaseIcon}
                    style={{ opacity: `${trevelersRoomCnt === 1 ? 0.5 : 1}` }}
                    onClick={(e) => {
                      handleAdulTrevelersRoomCnt(e, -1);
                    }}
                  >
                  ...
                  <div
                    className={styles.increseDecreaseIcon}
                    style={{ opacity: `${trevelersRoomCnt === 5 ? 0.5 : 1}` }}
                    onClick={(e) => {
                      handleAdulTrevelersRoomCnt(e, 1);
                    }}
                  >
              ...
              <div className={styles.trevelersFlexContainer}>
                ...
                <div className={styles.trevelersFlexChild}>
                  <div
                    className={styles.increseDecreaseIcon}
                    style={{ opacity: `${AdultsTrevelers === 1 ? 0.5 : 1}` }}
                    onClick={(e) => {
                      handleAdulTrevelersCnt(e, -1);
                    }}
                  >
                    <RemoveIcon className={styles.incDecIcon} />
                  </div>
              ...
              <div className={styles.trevelersFlexContainer}>
                ...
                <div className={styles.trevelersFlexChild}>
                  <div
                    className={styles.increseDecreaseIcon}
                    style={{ opacity: `${childrenCnt === 0 ? 0.5 : 1}` }}
                    onClick={(e) => {
                      handleChildrenCnt(e, -1);
                    }}
                  >
                    <RemoveIcon className={styles.incDecIcon} />
                  </div>
              ...
              <div style={{ textAlign: "left", paddingLeft: "10px" }}>
                <button
                  className={styles.trevelersSelectingDone}
                  onClick={(e) => {
                    e.stopPropagation();
                    setTrevelersPopupOpen("none");
                  }}
                >
                  Done
                </button>
        ...
        <div className={styles.searchBtnDiv}>
          <button style={{ cursor: "pointer" }} onClick={handleSaveData}>
            Search
          </button>
        </div>
      </TabPanel>
      <TabPanel value={value} index={1}>
        <div className={styles.hotelContainer}>
          <div
            style={{ width: "32%" }}
            className={`${styles.hotelBtns} ${styles.hotelGoingToBtn}`}
            onClick={(e) => {
              handleFlightLeavingOpenSearchPopup(e);
            }}
          >
            <LocationOnIcon className={styles.Icon} />
            <div className={styles.HeadingGoingto}>
              {flightLeavingVal === "" ? (
                ...
                <div>
                  <div className={styles.checkInHeading}>Leaving from</div>
                  <div className={styles.checkinDate}>{flightLeavingVal}</div>
                </div>
              )}
            </div>
            {/* -------Searching pop up bar------- */}
              ...
              <div className={styles.searchResultHight}>
                <div className={styles.SearchResult}>
                  <div
                    className={styles.SearchResultIndividual}
                    onClick={(e) => {
                      handleFlightLeavingCloseSearchPopup("Mumbai", e);
                    }}
                  >
          ...
          >
            <div
              className={styles.swapIconDiv}
              onClick={(e) => {
                e.stopPropagation();
                handleSwap();
              }}
            >
              <SwapHorizSharpIcon className={styles.swapIcon} />
            </div>
          ...
          >
            ...
            <div className={styles.HeadingGoingto}>
              {goingToVal === "" ? (
                ...
                <div>
                  <div className={styles.checkInHeading}>Pick up</div>
                  <div className={styles.checkinDate}>{goingToVal}</div>
                </div>
              )}
            </div>
      ...
      <TabPanel value={value} index={3}>
        <div className={styles.hotelContainer}>
          ...
          <div
            className={`${styles.hotelBtns} ${styles.hotelTraverls}`}
            onClick={(e) => {
              e.stopPropagation();
              setTrevelersPopupOpen("inline");
            }}
          ...
          >
            ...
            <div className={styles.HeadingGoingto}>
              {goingToVal === "" ? (
                ...
                <div>
                  <div className={styles.checkInHeading}>Things to do in</div>
                  <div className={styles.checkinDate}>{goingToVal}</div>
                </div>
              )}
            </div>
